...
class ImgSubscriber : public rclcpp :: Node
{
	...
	: Node("img_subscriber")
	{
		/* Use this when using for this package
		subscription_ = this->create_subscription<sensor_msgs::msg::Image>("video_frames",10, 
											std::bind(&ImgSubscriber::topic_callback,
											this,_1));
		*/
		//Use this when using double_cam_ros package
		subscription_ = this->create_subscription<sensor_msgs::msg::Image>("capture_frames",10, 
											std::bind(&ImgSubscriber::topic_callback,
											this,_1));
